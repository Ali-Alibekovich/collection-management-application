package io.github.alialibekovich.collection.client.ui;
...
import io.github.alialibekovich.collection.client.core.ConsoleManager;
...
public class ShowController {
    ...
    void initialize() {
        ...
        addButton.setOnAction(actionEvent -> {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getClassLoader().getResource("view/add.fxml"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        updateButton.setOnAction(actionEvent -> {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getClassLoader().getResource("view/update.fxml"));
            } catch (IOException e) {
                e.printStackTrace();
            }
            Scene scene = new Scene(root);
        ...
        addIfMinButton.setOnAction(actionEvent -> {
            ...
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getClassLoader().getResource("view/addifmin.fxml"));
            } catch (IOException e) {
                e.printStackTrace();
            }
            Scene scene = new Scene(root);
    ...
    public void openSort() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getClassLoader().getResource("view/sort.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        Scene scene = new Scene(root);
